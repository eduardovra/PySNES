...
def main() -> int:
    ...
    ap.add_argument("--force-tmw", type=lambda s: int(s, 0), default=None,
    ...
    state = {
        ...
        "tm": ppu.bg1.main_screen_enable * 1 | ppu.bg2.main_screen_enable * 2
              | ppu.bg3.main_screen_enable * 4 | ppu.bg4.main_screen_enable * 8,
        "ts": ppu.bg1.sub_screen_enable * 1 | ppu.bg2.sub_screen_enable * 2
              | ppu.bg3.sub_screen_enable * 4 | ppu.bg4.sub_screen_enable * 8,
        "tmw": ppu.tmw, "tsw": ppu.tsw,
        "w12sel": ppu.w12sel, "w34sel": ppu.w34sel, "wobjsel": ppu.wobjsel,
        "wh0": ppu.wh0, "wh1": ppu.wh1, "wh2": ppu.wh2, "wh3": ppu.wh3,
        "cgwsel": ppu.cgwsel, "cgadsub": ppu.cgadsub,
        "coldata_r": ppu.coldata_r, "coldata_g": ppu.coldata_g, "coldata_b": ppu.coldata_b,
        "bg1": dict(screen_addr=ppu.bg1.screen_addr, tiledata_addr=ppu.bg1.tiledata_addr,
                    hoffset=ppu.bg1.hoffset, voffset=ppu.bg1.voffset,
                    screen_size=getattr(ppu.bg1, "screen_size", None),
                    main=ppu.bg1.main_screen_enable, sub=ppu.bg1.sub_screen_enable),
        "bg2": dict(screen_addr=ppu.bg2.screen_addr, tiledata_addr=ppu.bg2.tiledata_addr,
                    hoffset=ppu.bg2.hoffset, voffset=ppu.bg2.voffset,
                    screen_size=getattr(ppu.bg2, "screen_size", None),
                    main=ppu.bg2.main_screen_enable, sub=ppu.bg2.sub_screen_enable),
        "bg3": dict(screen_addr=ppu.bg3.screen_addr, tiledata_addr=ppu.bg3.tiledata_addr,
                    hoffset=ppu.bg3.hoffset, voffset=ppu.bg3.voffset,
                    screen_size=getattr(ppu.bg3, "screen_size", None),
                    main=ppu.bg3.main_screen_enable, sub=ppu.bg3.sub_screen_enable),
        "bg4": dict(screen_addr=ppu.bg4.screen_addr, tiledata_addr=ppu.bg4.tiledata_addr,
                    hoffset=ppu.bg4.hoffset, voffset=ppu.bg4.voffset,
                    screen_size=getattr(ppu.bg4, "screen_size", None),
                    main=ppu.bg4.main_screen_enable, sub=ppu.bg4.sub_screen_enable),
    }
    ...
    print(f"dumped {base}.vram ({len(ppu.vram)}B), .cgram, .json, .bin", flush=True)
    return 0
